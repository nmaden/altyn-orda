...
use Cache;
class DerevoController extends SiteController
{
    ...
    public function index(Request $request,Figure $model)
	{
	   ...
	   $figures_page = view('orda' . '.derevo.catalog')->with(['items' => $items,'request' => $request])->render();
	...
	public function item(Request $request)
    {
	 ...
	 $figures_item = view('orda' . '.derevo.item')->with([
