...
<div class="row">
    ...
    <div class="col-md-3">
	 ...
	 <div class="col-md-3">
       <input-show name="rank_unikum" id="rank_unikum" :model='$model' />
    </div>
...
<div class="row">
    <div class="col-md-12">
        <input-select name="cat_id" id="cat_id" :model='$model' :value='$model->ar_cat_id' :dataar="$model->getCatAr()"/>
    </div>
	</br>
	 <div class="col-md-12">
		<input-select name="requirement_id" id="requirement_id" :model='$model' :dataar="$model->getRequirementAr()" disabled />
	</div>
	</br>
