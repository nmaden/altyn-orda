<?php
namespace Modules\Admin\Http\Controllers\Zayavka;
...
class ZayavkaController extends Controller {
    ...
    protected $view_path = 'admin::page.zayavka';
    protected $route_path = 'admin_zayavka';
    protected $title_path = 'title.zayavka';
