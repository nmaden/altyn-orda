        ...
        <div class="container">
            ...
            <div class="calendar__list--list">
                ...
                <div class="calendar__list--item">
                    ...
                    <a href="https://www.facebook.com/sharer.php?u=<?php echo $_SERVER['REQUEST_URI']; ?>&t={{$calendar->headers_title}}">
                    ...
                    <a href="https://vk.com/share.php?url=<?php echo $_SERVER['REQUEST_URI']; ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
