...
<head>
    ...
    <!-- home -->
    <body class="{{ Route::currentRouteName() == 'home' ? 'home-page' : ''}}{{ Route::currentRouteName() == 'derevo' ? 'derevo-page' : ''}}{{ Route::currentRouteName() == 'legenda' ? 'legenda-page' : ''}}{{ Route::currentRouteName() == 'legenda-item' ? 'legenda-page' : ''}}">
    @yield('navigation')
