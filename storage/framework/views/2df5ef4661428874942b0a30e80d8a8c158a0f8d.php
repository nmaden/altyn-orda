...
<head>
    ...
    <link rel="stylesheet" href="/css/style.css?v=3.5.9">
    <link rel="stylesheet" href="/css/media.css?v=3.5.9">
    ...
    <!-- home -->
    <body class="<?php echo e(Route::currentRouteName() == 'home' ? 'home-page' : ''); ?><?php echo e(Route::currentRouteName() == 'derevo' ? 'derevo-page' : ''); ?><?php echo e(Route::currentRouteName() == 'legenda' ? 'legenda-page' : ''); ?><?php echo e(Route::currentRouteName() == 'legenda-item' ? 'legenda-page' : ''); ?>">
