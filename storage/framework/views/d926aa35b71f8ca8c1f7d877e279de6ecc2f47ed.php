        ...
        <div class="container">
            ...
            <div class="calendar__list--list">
                ...
                <div class="calendar__list--item">
					...
					<?php if(isset($calendar->date)): ?>
					<?php echo e($calendar->date); ?>

				    <?php endif; ?>
                </div>
				<?php if(isset($calendar->relCity->name)): ?>

                <div class="calendar__list--item">
                    <strong>Город:</strong> 
					
					<?php echo e($calendar->relCity->name); ?>
                ...
                <div class="calendar__list--item">
                    ...
                    <div class="share__more__item">
                        <a data-href="https://www.facebook.com/sharer.php?u=<?php echo 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; ?>">
                    ...
                    <div class="share__more__item">
                        <a data-href="https://vk.com/share.php?url=<?php echo 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
            ...
            <div class="page__gallery page__img--main">
                ...
                <div class="page__gallery--item">
					...
					<?php if(isset($calendar->photo)): ?>
                        <img src="<?php echo e(URL::asset($calendar->photo)); ?>" alt="">
					<?php endif; ?>
                    </div>
                </div>
...
<?php /**PATH /home/vagrant/code/orda/resources/views/orda/calendars/calendar-item.blade.php ENDPATH**/ ?>