            ...
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                   <form action="<?php echo e(route($route_path.'_update_save', $model)); ?>" method="post" enctype="multipart/form-data" class="need_validate_form " novalidate>
					     ...
					     <?php else: ?>
						 <?php echo $__env->make($view.'.__form_lang', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                         <?php endif; ?>
                        </br>
...
<?php echo $__env->make('admin::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/orda/Modules/Admin/Resources/views/page/routes/update.blade.php ENDPATH**/ ?>